...
import { createDownloadArtifactsFunction } from '../functions/download_artifact';
...
function createStepsForIosSubmit(
  ...
  return [
    ...
    new BuildStep(globalCtx, {
      ...
      fn: async (stepCtx, { outputs }) => {
        ...
        try {
          ...
          stepCtx.logger.info(`Failed to find existing application artifacts.`);
        }
      },
    }),
    new BuildStep(globalCtx, {
    ...
    createDownloadArtifactsFunction().createBuildStepFromFunctionCall(globalCtx, {
    ...
    new BuildStep(globalCtx, {
      ...
      MAYBE_DOWNLOADED_ARTIFACT='\${ steps.download_artifacts.artifact_path }'
